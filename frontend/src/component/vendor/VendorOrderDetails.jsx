...
//             console.log(`Fetching orders for vendor ID: ${vendor._id}`);
...
//             console.log("Fetched Vendor Orders:", result);
...
//             <h1 className="text-2xl font-bold text-gray-800 mb-4">Vendor Orders</h1>
//             {orders.length === 0 ? (
...
//                                         ))}
//                                     </td>
//                                     <td className="py-3 px-4 border font-semibold text-green-600">
//                                         ₹{order.totalAmount}
//                                     </td>
//                                     <td className="py-3 px-4 border">
//                                         <p>{order.billingDetails.streetAddress1}</p>
//                                         <p>{order.billingDetails.city}, {order.billingDetails.state}</p>
//                                         <p>{order.billingDetails.country}, {order.billingDetails.zip}</p>
//                                         <p className="text-sm text-gray-500">{order.billingDetails.phone}</p>
//                                     </td>
//                                     <td className="py-3 px-4 border">
//                                         <span className="px-3 py-1 rounded-full text-white text-xs font-semibold bg-blue-500">
//                                             {order.status}
//                                         </span>
//                                     </td>
//                                     <td className="py-3 px-4 border">
