...
//       <div className="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2 gap-4">
//         {loading ? (
//           <p>Loading products...</p>
//         ) : error ? (
//           <p className="text-danger">{error}</p>
...
//         ) : (
//           products.slice(-4).map((product) => (
//             <div key={product._id} className="swiper-slide product-col flex flex-col items-center">
//               <div className="product-wrap product text-center">
//                 <figure className="product-media">
//                   <a href={`/${product.name.replace(/\s+/g, "-")}`}>
//                     <div className="w-full h-[243px] flex items-center justify-center overflow-hidden">
//                       <img
//                         src={`${BACKENDURL}/uploads/product/${product.images?.[0]?.urls?.[0].split("\\").pop()}`}
//                         alt={product.name}
//                         className="w-full h-full object-cover"
//                         style={{ maxWidth: "216px", height: "243px" }}
//                       />
//                     </div>
//                   </a>
//                   <div className="product-action-vertical">
