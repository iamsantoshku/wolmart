...
//                                 <h5 className="banner-subtitle font-weight-normal text-default ls-50 lh-1 mb-2 slide-animate">Custom <span className="p-relative d-inline-block">Men’s</span></h5>
//                                 <h3 className="banner-title font-weight-bolder ls-25 lh-1 slide-animate">RUNNING SHOES</h3>
//                                 <p className="font-weight-normal text-default slide-animate">Sale up to <span className="font-weight-bolder text-secondary">30% OFF</span></p>
//                                 <a href="shop-list.html" className="btn btn-dark btn-outline btn-rounded btn-icon-right slide-animate">SHOP NOW<i className="w-icon-long-arrow-right"></i></a>
//                             </div>
//                         </div>
//                     </div>
...
//                                 <h5 className="banner-subtitle font-weight-normal text-default ls-50 slide-animate">Mountain-<span className="text-secondary">Climbing</span></h5>
...
//                                 <a href="shop-banner-sidebar.html" className="btn btn-dark btn-outline btn-rounded btn-icon-right slide-animate">SHOP NOW<i className="w-icon-long-arrow-right"></i></a>
//                             </div>
//                         </div>
//                     </div>
...
//                                 <h3 className="banner-title p-relative font-weight-bolder ls-50 slide-animate"><span className="text-white mr-4">Roller</span>-skate</h3>
//                                 <div className="btn-group slide-animate">
//                                     <a href="shop-list.html" className="btn btn-dark btn-outline btn-rounded btn-icon-right">SHOP NOW<i className="w-icon-long-arrow-right"></i></a>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
