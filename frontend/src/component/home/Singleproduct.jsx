...
//       <div className="swiper-container swiper-theme nav-top swiper-nav-lg">
//         <div className="swiper-wrapper row cols-1 gutter-no">
//           <div className="swiper-slide">
//             <div className="product product-single row">
...
//                   <hr className="product-divider" />
//                   <div className="product-price">
//                     <ins className="new-price ls-50">${product.price}</ins>
//                   </div>
...
//                         <a
//                           href="#"
//                           className={`size ${selectedSize === sizeObj.size ? "active" : ""}`}
//                           key={sizeObj._id}
//                           onClick={(e) => {
//                             e.preventDefault();
//                             setSelectedSize(sizeObj.size);
