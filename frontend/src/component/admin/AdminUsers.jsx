...
// import { BACKENDURL } from "../../config/config"; // Ensure you have the correct backend URL
...
//                 <th className="py-3 px-4 text-left border-b">Shop Name</th>
...
//     try {
//       await axios.put(`${BACKENDURL}/api/v1/auth/update-role/${userId}`, 
//         { newRole }, 
...
//         { newRole }, // Ensure correct data format
