...
//                     <div className="product-meta">
//                       <span>Category: <a href="#">{product.category || "Unknown"}</a></span>
//                     </div>
...
//                       <h3>Description: {product.description || "None"}</h3>
//                     </div>
...
//                     <div className="product-form container">
//                       <div className="product-qty-form">
//                         <input className="quantity form-control" type="number" min="1" defaultValue="1" />
//                       </div>
//                       <button className="btn btn-primary btn-cart" onClick={handleAddToCart}>
//                         <i className="w-icon-cart"></i> <span>Add to Cart</span>
//                       </button>
//                     </div>
//                   </div>
//                 </div>
